        ...
        <div className="border-t border-b border-glass-border py-8 mb-8">
          <div className="flex flex-col items-center text-center gap-4 max-w-3xl mx-auto">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              Jika Anda menemukan bug, hasil analisis yang kurang akurat, atau memiliki saran fitur baru, silakan kirim masukan kepada kami.
            </p>
            <a 
              href="https://wa.me/6288210960161"
              target="_blank"
